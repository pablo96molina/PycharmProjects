...
#Seleccion y procesamiento de los datos
...
#Definimos test de entrenamiento y prueba
...
#El puntaje F1 es el promedio armónico de la precisión y grado, donde un grado F1 alcanza su mejor valor en 1 (precisión
# y grado perfectos) y peor escenario en 0.
# Es una buena forma de mostrar que un clasificador tiene un buen valor tanto para la precisión como para el grado.
